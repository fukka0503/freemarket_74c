...
ActiveRecord::Schema.define(version: 2020_05_20_204129) do
  ...
  create_table "purchases", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["delivery_address_id"], name: "index_purchases_on_delivery_address_id"
  ...
  add_foreign_key "purchases", "delivery_addresses"
